        ...
        <>
            <div className='md:w-3/5 w-full mx-auto rounded drop-shadow-lg bg-white mt-5 h-content'>
                ...
                <div className='flex mx-auto w-full  flex-col p-5 '>
                    ...
                    <input type="text" className='mt-8 py-2 px-2 drop-shadow-lg rounded' placeholder='Address' />
        ...
        <>
            <div className='md:w-3/5 w-full mx-auto rounded drop-shadow-lg bg-white mt-5 h-content'>
                ...
                <div className='flex flex-col p-5 md:pb-40 pb-32 '>
                    ...
                    <select name="years" onChange={handleChangeYear} className='rounded drop-shadow py-2 px-2' id="years">
                        {year.map((val, key) => {
                            return (
  ...
  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clipRule="evenodd" />
    ...
    <div id="collapseOne" className="accordion-collapse collapse" aria-labelledby="headingOne"
      ...
      <label className='font-bold'>
            <input className='mr-1' name='n' onClick={handleChange(Class10)} type="checkbox" />
          SelectAll
         </label> 
       {Class10.map((val,key)=>{
        return(<>
        ...
        <label>
            <input type='checkbox' checked={isChecked} name="n" className='mr-1' value={val.name}/>
         {val.name} </label>
         </> )})}
      </div>
    </div>
            ...
            <div className='md:w-3/5 w-full mx-auto mt-5 rounded drop-shadow-lg bg-white h-content'>
                ...
                <div className='pt-7 flex flex-col pl-8'>
                    ...
                    <label htmlFor="" className='mt-5'>
                        <input type="checkbox" /> Home Tutoring</label>
                    <label htmlFor="">
                        <input type="checkbox" /> Online Tutoring</label>
                    <label htmlFor="">
                        <input type="checkbox" /> School Jobs</label>
                    <label htmlFor="">
                        <input type="checkbox" /> Institute Jobs</label>
